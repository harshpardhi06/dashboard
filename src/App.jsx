...
function FlowNode({ icon: Icon, iconType, label, value }) {
  return (
    <div className="flow-node">
      <div className={`flow-node-icon ${iconType}`}>
        <Icon />
      </div>
    ...
    <div className="dashboard">
      ...
      <header className="header">
        <div className="header-left">
          <div className="logo">आ</div>
          <div>
            <h1 className="header-title">Aadhar Dashboard</h1>
            <p className="header-subtitle">WhatsApp Campaign Analytics</p>
          </div>
        </div>
      ...
      <div className="stats-grid">
        ...
        <StatCard
          ...
          value={data.campaign.flowCompleted}
        ...
        <StatCard
          icon={Icons.XCircle}
          label="Not Completed"
          value={animatedValues.notCompleted}
          change="Incomplete flows"
          changeType="negative"
          type="failed"
        />
      </div>
      ...
      <div className="content-grid">
        ...
        <div className="card">
          ...
          <div className="flow-chart">
            ...
            {/* Branch for Flow Completed / Not Completed */}
            ...
            <div className="progress-container">
              <div className="progress-header">
                <span className="progress-label">Overall Flow Completion Rate</span>
          ...
          <div className="response-chart">
            ...
            <div className="response-chart-center">
              <div className="response-chart-value">
                {Math.round((data.campaign.mbuYes / data.campaign.flowCompleted) * 100)}%
              </div>
      ...
      <div className="bottom-grid">
        ...
        {/* BOT Levels - Non-User Input (Readonly) */}
        <div className="card">
          <div className="card-header">
            <div className="card-title">
              <div className="card-title-icon">
          ...
          <tbody>
            {data.recentCampaigns.map((campaign) => (
              <tr key={campaign.id}>
                ...
                <td style={{ fontWeight: 600, color: campaign.response !== '-' ? 'var(--accent-green)' : 'var(--text-muted)' }}>
                  {campaign.response}
                </td>
              </tr>
            ))}
